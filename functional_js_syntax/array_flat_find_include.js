...
const hasAbc = ids.find((item) => item.includes('ABC'));
...
const hasEqualValue = A.filter((itemA) => B.includes(itemA));
const hasEqualValue2 = A.map((itemA) => B.includes(itemA));

console.log(hasEqualValue);
// [ '2389sakvjhw8e7f09fv' ]
console.log(hasEqualValue2);
